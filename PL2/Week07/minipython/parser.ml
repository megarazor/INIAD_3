...
# 201 "/home/megarazor/.opam/system/lib/menhir/standard.mly"
    ( x :: xs )
# 107 "parser.ml"
         in
...
# 144 "/home/megarazor/.opam/system/lib/menhir/standard.mly"
    ( x )
# 145 "parser.ml"
             in
...
and _menhir_reduce11 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    let _v : 'tv_list_stmt_ = 
# 199 "/home/megarazor/.opam/system/lib/menhir/standard.mly"
    ( [] )
# 252 "parser.ml"
     in
...
# 231 "/home/megarazor/.opam/system/lib/menhir/standard.mly"
    ( x :: xs )
# 386 "parser.ml"
         in
...
# 220 "/home/megarazor/.opam/system/lib/menhir/standard.mly"
    ( xs )
# 506 "parser.ml"
...
# 7 "parser.mly"
       (string)
# 608 "parser.ml"
            ))), _, (xs0 : 'tv_loption_separated_nonempty_list_COMMA_IDENT__)), _, (_9 : 'tv_stmt_list)) = _menhir_stack in
            let _10 = () in
            let _8 = () in
            let _7 = () in
            let _6 = () in
    ...
    | MenhirState37 ->
        ...
        | DEDENT ->
            ...
            | DEDENT | DEF | EOF | IDENT _ | IF | INT _ | LPAREN | NEWLINE | RETURN | STRING _ | WHILE ->
                ...
                ((let _v : 'tv_loption_else_term_ = 
# 142 "/home/megarazor/.opam/system/lib/menhir/standard.mly"
    ( [] )
# 736 "parser.ml"
                 in
  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState19 | MenhirState6 ->
        ...
        | RPAREN ->
            ...
            let _v : 'tv_separated_nonempty_list_COMMA_expr_ = 
# 229 "/home/megarazor/.opam/system/lib/menhir/standard.mly"
    ( [ x ] )
# 903 "parser.ml"
             in
...
# 233 "/home/megarazor/.opam/system/lib/menhir/standard.mly"
